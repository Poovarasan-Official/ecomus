...
<i className="fa fa-truck"></i>
  <p className='premium-header'>Free Shipping</p>
...
<p className='premium-header'>Flexible Payment</p>
...
<p className='premium-header'>14 Day Returns</p>
...
<p className='premium-header'>Premium Support</p>
